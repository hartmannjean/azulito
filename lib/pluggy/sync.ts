 ...
 *
 * Compartilhado entre o webhook (`/api/pluggy/webhook`) e o polling de apoio
 * (`/api/pluggy/sync`) para os dois caminhos gravarem transações da mesma
 * forma e com a mesma chave de idempotência.
 */
